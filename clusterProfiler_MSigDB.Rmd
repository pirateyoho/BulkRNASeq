...
setwd("~/ProjectDirectory/02_scripts") # Replace with path to your local scripts directory
# Read in data from deseq2
df = read.csv("../03_output/DESeq2res.csv", header=TRUE) # Replace with name of file of DESeq2 results exported in CSV format
...
write.csv(gse_msigdb_df, file="../GSEA/Output/gseaMSigDBAll.csv") # Replace with desired output path and filename
...
write.csv(enriched_msigdb_df, file="../GSEA/Output/enricherMSigDBtop250.csv") # Replace with desired output path and filename
```
